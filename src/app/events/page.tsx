...
const events = [
  {
    ...
    description: "Join us for a 2-day intensive hackathon focused on creating innovative solutions using Artificial Intelligence. Prizes for top 3 teams!",
  },
  {
    ...
    <div className="container mx-auto py-12 md:py-20">
      <div className="text-center">
        ...
        <p className="mt-4 max-w-2xl mx-auto text-lg text-muted-foreground">
          Join our hackathons and workshops to learn, build, and network.
        </p>
      </div>
